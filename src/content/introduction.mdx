...
<CardGroup cols={3}>
  <Card title="Product-change pipeline" icon="code-simple" href="/product-change-pipeline">
    See how product evidence becomes reviewable customer-facing knowledge.
  </Card>
  ...
  <Card title="Thally Track" icon="git-pull-request" href="/guides/thally-track">
    Product changes become evidence-backed docs pull requests for your team to review.
  </Card>
</CardGroup>
