...
After this guide, Thally will generate grouped endpoint pages from your OpenAPI
3.x document. You need a valid YAML or JSON specification and a local Thally
project.
