...
On a connected Thally Cloud deployment, an Editor or Owner can set a hashed
visitor password under **Admin → Settings → Access & authentication**. The
managed setting takes precedence when it is present.
...
`/admin`; configure the methods in [Manage the live site](/guides/admin-dashboard).
...
- [Admin dashboard and team access](/guides/admin-dashboard)
