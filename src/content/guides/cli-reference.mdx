...
# Choose Mintlify, Docusaurus, or auto-detection interactively
...
<Warning>
If you omit both `--platform` and `--yes`, the CLI asks which platform currently hosts the docs. If you pass `--yes` without `--platform`, it uses auto-detection.
</Warning>
