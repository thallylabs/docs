---
title: Create a Thally project
description: Choose the right setup path for a new documentation site, an existing docs repository, or an automated installation.
---

Use this guide when you need more control than the [Quickstart](/quickstart).
Choose one setup path based on what you already have.

<CardGroup cols={3}>
  <Card title="Start a new site" icon="code-simple" href="#start-a-new-site">
