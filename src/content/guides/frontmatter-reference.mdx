...
| --- | --- | --- | --- |
| `title` | string | File name converted to words | Page heading, browser title, search result, and sidebar label. |
...
| `lastUpdated` | date string | Build date | Last content update date. |
